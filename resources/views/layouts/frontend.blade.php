                ...
                <header>
                        <div class="container ">
                          ...
                          <div class="row nomargin">
                            <div class="span12">
                              <div class="headnav">
                                <ul>
                                  <li class="shakee">
                                  <a class="btn btn-theme btn-rounded " href="#bookappointment" data-toggle="modal"><i class="icon-user"></i> Book Appointment</a>
                                  </li>
                              ...
                              <div id="bookappointment" class="modal styled hide fade" tabindex="-1" role="dialog" aria-labelledby="mySignupModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-body">
                                  <form class="form-horizontal" id="" method="post">
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <input type="text"  name="mobile" required id="inputMobile" placeholder="Mobile Number">
                                      </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <input type="text"  name="location" required id="inputLocation" placeholder="Location">
                                      </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                        <textarea  name="message" required id="inputMessage" placeholder="Message"></textarea>
                                      </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                      <div class="controls">
                                        <button type="submit" class="btn btn-md btn-secondary" id="appoitmentForm">Book Appointment</button>
                          ...
                          <div class="row">
                            <div class="span4">
                              <div class="logo">
                                <a href="{{ route('indexpage') }}"><img src="{{ asset('wb/img/logo3.png') }}" width="180" alt="" class="logo" /></a>
